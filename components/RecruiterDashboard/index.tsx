  ...
  return (
    <div className="relative min-h-screen w-full bg-[#050508]">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <CinematicSection id="about" className="w-full py-32" duration={0.8}>
          <AboutSection />
        </CinematicSection>

        {/* Section 3: Professional KPIs */}
        <CinematicSection className="w-full py-32 bg-white/[0.01]" duration={0.8}>
          <KpiSection />
        </CinematicSection>

        {/* Section 4: Technical Skills Explorer */}
        <CinematicSection id="skills" className="w-full py-32" duration={0.8}>
          <SkillsExplorerSection />
        </CinematicSection>

        {/* Section 5: Experience Profile */}
        <CinematicSection id="experience" className="w-full py-32 bg-white/[0.01]" duration={1.0}>
          <ExperienceSection />
        </CinematicSection>

        {/* Section 6: Achievements */}
        <CinematicSection id="achievements" className="w-full py-32" duration={0.8}>
          <AchievementsSection />
        </CinematicSection>

        {/* Section 7: Certifications */}
        <CinematicSection id="certifications" className="w-full py-32 bg-white/[0.01]" duration={0.8}>
          <CertificationsSection />
        </CinematicSection>

        {/* Section 8: Contact & Hire */}
        <CinematicSection id="contact" className="w-full py-32" duration={0.8}>
