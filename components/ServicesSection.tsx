      ...
      >
        {(portfolioData.services || []).map((service, index) => (
          ...
          >
            ...
            <div className="shrink-0 w-20 h-20 rounded-[28px] bg-cyan-400/10 border border-cyan-400/30 flex items-center justify-center text-cyan-400 group-hover:bg-cyan-400 group-hover:text-black transition-all duration-700 p-5 shadow-lg group-hover:shadow-cyan-400/20">
